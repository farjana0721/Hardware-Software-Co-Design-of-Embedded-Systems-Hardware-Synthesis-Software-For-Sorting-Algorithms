...
architecture str_arch of bubble is
   ...
   signal clr_sec, inc_sec, clr_alc, inc_alc: std_logic;
   signal new_min, mvar_ld, mvr_ld, ler_ld: std_logic;
   signal min_value_addr, min_value, ler_value: std_logic_vector(7 downto 0);
   signal lec_value, rec_value, sec_value, alc_value: std_logic_vector(7 downto 0);
